...
<body id="body">
    ...
    <div class="d-flex align-items-center justify-content-center border border-dark border-2 p-2 text-center">  
        ...
        <button id="emitir" class=" border border-dark border-1 border rounded-2 m-1 fs-2 fw-bold">  Emitir Relatórios <i class="fa-regular fa-clipboard ms-1"></i> </button>
...
<script>
    ...
    infoBox.className = 'enfa info-box expand-btn d-flex border border-dark border-1 border rounded-2 my-2 w-100 fs-3 text-wrap fw-bold  align-items-center justify-content-center text-center';
    infoBox.innerHTML = `
